            ...
            <table>
               ...
               <?php
                ...
                if(isset($_POST['submit'])){
                    ...
                    $query="select * from `bill_payment` where date between '$from_dates' and '$to_dates';";
                  ...
                  $query="SELECT * FROM `bill_payment` WHERE user_id='{$_SESSION['user_id']}'";
                        $result=mysqli_query($connect,$query);
                        if($result){
                            $tb="<tr>";
                            $tb.="<th>Accont-number</th>";
