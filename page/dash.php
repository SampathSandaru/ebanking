        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="td1">
                    <table class="t1">
                        <tr>
                            <td><a href="account.php" style="text-decoration: none;">Account</a></td>
                        </tr>
                        <tr>
                            <td><a href="inter_bank_tranfer.php" style="text-decoration: none;">Fund Transer</a></td>
                        </tr>
                         <tr>
                            <td><a href="paybill.php" style="text-decoration: none;">Bill Payment</a></td>
                        </tr>
            ...
            <div class="col-md-3">
                ...
                <div class="dash1">
                    <ul class="list-group">
                        <li class="list-group-item">Registration for online Banking by Admin</li>
                        <li class="list-group-item">You Can view Transaction History</li>
                        <li class="list-group-item">You Can Download the Account statment Whith a date range</li>
                        <li class="list-group-item">you can your problem presented to the bank</li>
                        <li class="list-group-item">you can Money Transfer to the all Bank in Local & All Mobile Bill Payment</li>
                        <li class="list-group-item">you can Edit your profile</li>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <table class="footer_table">
                        ...
                        <tr>
                            <td>Question</td>
                            <td><textarea cols="30" rows="5" class="form-control" name="msg" required></textarea> </td>
                        </tr>
                          <tr>
                            <td></td>
