...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $bank=$_POST['bank'];
        header("location:other_bank_tranfer_comfirm_page.php?to_acc=$to_acc&amount=$amount&email=$email&s_acc=$acc_n&acc_name=$acc_name&bank=$bank");
    }
?>
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12">
                <center>
                    <div class="box">
                        <form method="post" action="other_bank_tranfer.php">
                        <table class="ani">
                            <tr>
